...
const I18N = {
  ja: {
    ...
    remoteTtsModelLabel: 'リモートモデル',
    remoteTtsVoiceLabel: 'リモート音声',
    ttsStatusAvailable: '利用可能',
    ttsStatusRequestFailed: 'リクエスト失敗',
    ttsCacheHit: '音声キャッシュを使用しました',
    ttsCacheMiss: '音声を新しく生成しました',
    speedLabel: '話速',
    playAll: '全文再生',
    displayTitle: '表示設定',
    showKana: 'ふりがなを表示',
  ...
  en: {
    ...
    ttsProviderSystem: 'System',
    ttsProviderRemote: 'Remote',
    remoteTtsModelLabel: 'Remote Model',
    remoteTtsVoiceLabel: 'Remote Voice',
    ttsStatusAvailable: 'Available',
    ttsStatusRequestFailed: 'Request failed',
    ttsCacheHit: 'Used cached audio',
    ttsCacheMiss: 'Generated fresh audio',
    speedLabel: 'Speed',
    playAll: 'Play All',
  ...
  zh: {
    ...
    remoteTtsModelLabel: '远程模型',
    remoteTtsVoiceLabel: '远程音色',
    ttsStatusAvailable: '可用',
    ttsStatusRequestFailed: '请求失败',
    ttsCacheHit: '已使用音频缓存',
    ttsCacheMiss: '已重新生成音频',
    speedLabel: '语速调节',
    playAll: '播放全文',
    displayTitle: '显示设置',
    showKana: '显示假名',
